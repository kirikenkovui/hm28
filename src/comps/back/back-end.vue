...
function deleteRequest(contact) {
...
function confirmDelete() {
    ...
    deletedRequests.value[confirmDeleteId.value] = true;
                        ...
                        <div class="card-header" @click="toggleExpanded(contact.id)">
                            ...
                            <div class="card-header-right">
                                ...
                                <div class="card-actions">
                                    ...
                                    <button class="btn-action btn-delete" @click.stop="deleteRequest(contact)">Delete</button>
        ...
        <Transition name="modal-fade">
            <div v-if="confirmDeleteId" class="modal-overlay" @click.self="cancelDelete">
                <div class="modal">
                    ...
                    <p class="modal-body">
                        <strong>{{ confirmDeleteName }}</strong> will be
                        permanently removed. This cannot be undone.
                    </p>
                    <div class="modal-actions">
                        <button class="modal-btn modal-btn--cancel" @click="cancelDelete">Cancel</button>
                        <button class="modal-btn modal-btn--confirm" @click="confirmDelete">Yes, delete</button>
                    </div>
                </div>
            </div>
        </Transition>
...
.modal-body strong { color: #171642; font-weight: 700; }
...
.modal-btn--cancel { background: transparent; color: #171642; }
.modal-btn--cancel:hover { background: #171642; color: #ffffff; }

.modal-btn--confirm { background: #cc0000; color: #ffffff; border-color: #cc0000; }
.modal-btn--confirm:hover { background: #a30000; border-color: #a30000; }
